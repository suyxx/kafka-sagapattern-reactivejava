...
public class DuplicateEventValidator {
    ...
    public static final Logger log = LoggerFactory.getLogger(DuplicateEventValidator.class);
    ...
    public static Function<Mono<Boolean>, Mono<Void>> emitErrorForRedundantProcessing(){
        return mono -> mono
                ...
                .doOnError(EventAlreadyProcessedException.class, ex -> log.warn("Dupllicate event"))
                .then();
    }
